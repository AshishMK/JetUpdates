...
package com.demo.jetupdates.feature.bookmarks.impl
...
import com.demo.jetupdates.feature.cart.impl.CartViewModel
...
class CartViewModelTest {
    ...
    fun stateIsInitiallyLoading() = runTest {
        assertEquals(ItemFeedUiState.Loading, viewModel.feedUiState.value)
    }
    ...
    fun oneItem_showsInCart() = runTest {
        ...
        assertIs<ItemFeedUiState.Success>(item)
    ...
    fun feedUiState_itemIsViewed_setItemViewed() = runTest {
        ...
        assertIs<ItemFeedUiState.Success>(itemBeforeViewed)
    ...
    fun feedUiState_undoneItemRemoval_itemIsRestored() = runTest {
        ...
        assertIs<ItemFeedUiState.Success>(itemBeforeUndo)
