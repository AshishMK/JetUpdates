...
package com.demo.jetupdates.feature.cart.impl
...
import com.demo.jetupdates.feature.cart.api.R
...
internal fun CartScreen(
    ...
    val bookmarkRemovedMessage = stringResource(id = R.string.feature_cart_api_removed)
    val undoText = stringResource(id = R.string.feature_cart_api_undo)
...
private fun LoadingState(modifier: Modifier = Modifier) {
    AppLoadingWheel(
        ...
        contentDesc = stringResource(id = R.string.feature_cart_api_loading),
    )
}
...
private fun EmptyState(modifier: Modifier = Modifier) {
    Column(
        ...
        Image(
            ...
            painter = painterResource(id = R.drawable.feature_cart_api_img_empty_cart),
        ...
        Text(
            text = stringResource(id = R.string.feature_cart_api_empty_error),
            modifier = Modifier.fillMaxWidth(),
        ...
        Text(
            text = stringResource(id = R.string.feature_cart_api_empty_description),
            modifier = Modifier.fillMaxWidth(),
            textAlign = TextAlign.Center,
