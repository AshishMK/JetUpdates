...
class CartScreenTest {
    ...
    fun loading_showsLoadingSpinner() {
        ...
        composeTestRule
            .onNodeWithContentDescription(
                composeTestRule.activity.resources.getString(R.string.feature_cart_api_loading),
            )
            .assertExists()
    }
    ...
    fun feed_whenHasNoItems_showsEmptyState() {
        ...
        composeTestRule
            .onNodeWithText(
                composeTestRule.activity.getString(R.string.feature_cart_api_empty_error),
            )
            .assertExists()

        composeTestRule
            .onNodeWithText(
                composeTestRule.activity.getString(R.string.feature_cart_api_empty_description),
            )
            .assertExists()
    }
