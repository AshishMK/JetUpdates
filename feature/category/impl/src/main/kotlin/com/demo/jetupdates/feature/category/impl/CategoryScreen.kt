...
package com.demo.jetupdates.feature.category.impl
...
import com.demo.jetupdates.core.ui.R as UiR
import com.demo.jetupdates.feature.category.api.R as CategoryR
        ...
        LazyVerticalStaggeredGrid(
            ...
            when (categoryUiState) {
                CategoryUiState.Loading -> item {
                    AppLoadingWheel(
                        modifier = modifier,
                        contentDesc = stringResource(id = CategoryR.string.feature_category_api_loading),
                    )
                }
...
private fun shopItemsSize(
    ...
    CategoryUiState.Error -> 0 // Nothing
    CategoryUiState.Loading -> 1 // Loading bar
    is CategoryUiState.Success -> when (shopItemUiState) {
