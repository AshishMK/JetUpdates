...
class StoreScreenTest {
    ...
    private val doneButtonMatcher by lazy {
        hasText(
            composeTestRule.activity.resources.getString(R.string.feature_store_api_done),
        )
    }
    ...
    fun circularProgressIndicator_whenScreenIsLoading_exists() {
        ...
        composeTestRule
            .onNodeWithContentDescription(
                composeTestRule.activity.resources.getString(R.string.feature_store_api_loading),
            )
            .assertExists()
    }
