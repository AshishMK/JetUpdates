...
class ProductViewModel @AssistedInject constructor(
    ...
    // var shopItemId: Int = productId//route.initialProductId

    val productUiState: StateFlow<ProductUiState> =
        userShopItemRepository.observeItem(productId) // route.initialProductId)
    ...
    fun bookmarkItem(addToCart: Boolean) {
        viewModelScope.launch {
            ...
            userDataRepository.setShopItemBookmarked(productId, addToCart)
        }
    }
