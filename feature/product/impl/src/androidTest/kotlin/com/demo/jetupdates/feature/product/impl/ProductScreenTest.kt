...
package com.demo.jetupdates.feature.product.impl
...
class ProductScreenTest {
    ...
    fun setup() {
        composeTestRule.activity.apply {
            addToCart = getString(R.string.core_ui_add_to_cart)
            removeFromCart = getString(R.string.core_ui_remove_from_cart)
        }
    }
            ...
            SharedTransitionLayout {
                AnimatedVisibility(visible = true) {
                    CompositionLocalProvider(
                        ...
                        isCompact =
                            currentWindowAdaptiveInfo().windowSizeClass.windowWidthSizeClass == WindowWidthSizeClass.Companion.COMPACT
                        ProductScreen(
                            productUiState = userShopItemsTestData[0],
                            id = userShopItemsTestData[0].id,
                            onBackClick = {},
