...
class ProductViewModelTest {
    ...
    fun setup() {
        /*viewModel = ProductViewModel(
            ...
            savedStateHandle = SavedStateHandle.Companion(route = ProductRoute(initialProductId = userShopItemsTestData[0].id)),
        )*/
        viewModel = ProductViewModel(
            userDataRepository = userDataRepository,
            userShopItemRepository = userShopItemRepository,
            productId = userShopItemsTestData[0].id,
        )
    }

    var shopItemId: String = userShopItemsTestData[0].id
    val sample = ShopItem(
        id = "1",
