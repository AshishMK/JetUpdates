...
@Composable
fun TrendingDetailPlaceholder(modifier: Modifier = Modifier) {
    Card(
        modifier = modifier,
        ...
        Column(
            ...
            Icon(
                painter = painterResource(id = R.drawable.feature_trending_api_ic_detail_placeholder),
                contentDescription = null,
                tint = MaterialTheme.colorScheme.primary,
            )
            Text(
                text = stringResource(id = R.string.feature_trending_api_select_an_trending),
