...
import com.demo.jetupdates.feature.trending.impl.TrendingUiState
...
class TrendingScreenTest {
    ...
    fun setup() {
        composeTestRule.activity.apply {
            trendingLoading = getString(TrendingR.string.feature_trending_api_loading)
            trendingEmptyHeader = getString(TrendingR.string.feature_trending_api_empty_header)
