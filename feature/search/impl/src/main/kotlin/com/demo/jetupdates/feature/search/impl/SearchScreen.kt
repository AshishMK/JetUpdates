...
import com.demo.jetupdates.feature.search.api.R as searchR
...
fun EmptySearchResultBody(
    ...
    Column(
        ...
        val message =
            stringResource(id = searchR.string.feature_search_api_result_not_found, searchQuery)
        ...
        val tryAnotherSearchString = buildAnnotatedString {
            ...
            withLink(
                ...
                withStyle(
                    ...
                    append(stringResource(id = searchR.string.feature_search_api_trending))
                }
            }

            append(" ")
            append(stringResource(id = searchR.string.feature_search_api_to_browse_categories))
        }
        Text(
                    ...
                    Text(
                        text = buildAnnotatedString {
                            withStyle(style = SpanStyle(fontWeight = FontWeight.Bold)) {
                                append(stringResource(id = searchR.string.feature_search_api_category))
                            }
                        },
