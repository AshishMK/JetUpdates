...
package com.demo.jetupdates.feature.search.impl
...
import com.demo.jetupdates.feature.search.api.R
...
class SearchScreenTest {
    ...
    fun setup() {
        composeTestRule.activity.apply {
            ...
            followButtonContentDesc =
                getString(com.demo.jetupdates.core.ui.R.string.core_ui_trending_card_follow_button_content_desc)
            unfollowButtonContentDesc =
                getString(com.demo.jetupdates.core.ui.R.string.core_ui_trending_card_unfollow_button_content_desc)
            categoriesString = getString(R.string.feature_search_api_category)
            ...
            tryAnotherSearchString = getString(R.string.feature_search_api_try_another_search) +
                " " + getString(R.string.feature_search_api_trending) + " " + getString(R.string.feature_search_api_to_browse_categories)
    ...
    @Test
    fun searchResultWithCategories_allTopicsAreVisible_followButtonsVisibleForTheNumOfFollowedCategories() {
        appThemeWithAnimationScopes {
            SearchScreen(
                searchResultUiState = SearchResultUiState.Success(categories = followableCategoryTestData),
            )
        }
