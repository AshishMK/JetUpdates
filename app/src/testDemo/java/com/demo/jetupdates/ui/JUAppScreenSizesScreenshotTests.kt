...
@HiltAndroidTest
class JUAppScreenSizesScreenshotTests {
    ...
    @Inject
    lateinit var userShopItemRepository: UserShopItemRepository
    ...
    private fun testJuAppScreenshotWithSize(width: Dp, height: Dp, screenshotName: String) {
        composeTestRule.setContent {
            CompositionLocalProvider(
                ...
                DeviceConfigurationOverride(
                    ...
                    AppTheme {
                        val fakeAppState = rememberJUAppState(
