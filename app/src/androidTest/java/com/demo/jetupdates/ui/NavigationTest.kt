...
class NavigationTest {
    ...
    private val forYou by composeTestRule.stringResource(FeatureStoreR.string.feature_store_title)
...
//    }
      ...
      fun navigationBar_multipleBackStackInterests() {
          composeTestRule.apply {
              ...
              val topic = runBlocking {
                  categoriesRepository.getTopics().first().sortedBy(Topic::name).last()
              }
    ...
    fun navigatingToTopicFromForYou_showsTopicDetails() {
        composeTestRule.apply {
            ...
            onNodeWithText(topic.name).performClick()
            Thread.sleep(1000)
            //kamal composeTestRule.waitxxForIdle()
