 ...
 * provides list of [FollowableCategory] for Composable previews.
 */
class FollowableCategoryPreviewParameterProvider :
    PreviewParameterProvider<List<FollowableCategory2>> {
    override val values: Sequence<List<FollowableCategory2>>
        get() = sequenceOf(
            listOf(
                FollowableCategory2(
                    category = Category(
