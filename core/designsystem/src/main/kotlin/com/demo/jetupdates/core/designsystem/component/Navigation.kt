...
/**
 * JU App navigation bar item with icon and label content slots. Wraps Material 3
 * [NavigationBarItem].
 *
...
/**
 * JU App navigation bar with content slot. Wraps Material 3 [NavigationBar].
 *
...
/**
 * JU App navigation rail item with icon and label content slots. Wraps Material 3
 * [NavigationRailItem].
 *
 * @param selected Whether this item is selected.
 * @param onClick The callback to be invoked when this item is selected.
...
/**
 * JU App navigation rail with header and content slots. Wraps Material 3 [NavigationRail].
 *
...
/**
 * JU App navigation suite scaffold with item and content slots.
 * Wraps Material 3 [NavigationSuiteScaffold].
 *
 * @param modifier Modifier to be applied to the navigation suite scaffold.
 * @param navigationSuiteItems A slot to display multiple items via [AppNavigationSuiteScope].
...
/**
 * JU App navigation default values.
 */
