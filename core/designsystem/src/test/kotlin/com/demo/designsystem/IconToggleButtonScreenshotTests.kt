...
class IconToggleButtonScreenshotTests {

    @get:Rule
    val composeTestRule = createAndroidComposeRule<ComponentActivity>()

    @Test
    fun iconToggleButton_multipleThemes() {
        composeTestRule.captureMultiTheme("IconToggleButton") {
            appIconToggleExample(false)
        }
    }

    @Test
    fun iconToggleButton_unchecked_multipleThemes() {
        composeTestRule.captureMultiTheme("IconToggleButton", "IconToggleButtonUnchecked") {
            Surface {
