...
import com.demo.jetupdates.core.designsystem.component.AppNavigationBar
import com.demo.jetupdates.core.designsystem.component.AppNavigationBarItem
        ...
        AppNavigationBar {
            (0..2).forEach { index ->
                AppNavigationBarItem(
                    icon = {
                        Icon(
                            imageVector = AppIcons.StoreBorder,
                            contentDescription = "",
                        )
                    },
                    selectedIcon = {
