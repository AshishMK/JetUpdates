...
package com.demo.jetupdates.core.data.test

import com.demo.jetupdates.core.data.di.DataModule
...
import com.demo.jetupdates.core.data.test.repository.FakeCategoriesRepository
import com.demo.jetupdates.core.data.test.repository.FakeRecentSearchRepository
import com.demo.jetupdates.core.data.test.repository.FakeSearchContentsRepository
import com.demo.jetupdates.core.data.test.repository.FakeShopRepository
import com.demo.jetupdates.core.data.test.repository.FakeUserDataRepository
...
internal interface TestDataModule {
    ...
    fun bindsCategoriesRepository(
        fakeCategoriesRepository: FakeCategoriesRepository,
    ): CategoriesRepository

    @Binds
    fun bindsShopItemRepository(
