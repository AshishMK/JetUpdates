...
class DesignSystemDetector : Detector(), Detector.UastScanner {
    ...
    companion object {
        ...
        val METHOD_NAMES = mapOf(
            ...
            "Button" to "AppButton",
            "OutlinedButton" to "AppOutlinedButton",
            "TextButton" to "AppTextButton",
            "FilterChip" to "AppFilterChip",
            "ElevatedFilterChip" to "AppFilterChip",
            ...
            "TabRow" to "AppTabRow",
            "Tab" to "AppTab",
            "IconToggleButton" to "AppIconToggleButton",
            "FilledIconToggleButton" to "AppIconToggleButton",
            "FilledTonalIconToggleButton" to "AppIconToggleButton",
            "OutlinedIconToggleButton" to "AppIconToggleButton",
            "CenterAlignedTopAppBar" to "AppTopAppBar",
            "SmallTopAppBar" to "AppTopAppBar",
            "MediumTopAppBar" to "AppTopAppBar",
            "LargeTopAppBar" to "AppTopAppBar",
        )
